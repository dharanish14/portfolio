                    ...
                    <div className="flex-1 text-center lg:text-left max-w-2xl order-2 lg:order-1">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10 w-full max-w-xl mx-auto lg:mx-0">
                            ...
                            >
                                ...
                                <span className="relative z-10 font-orbitron text-[8px] md:text-xs tracking-wider text-text-secondary group-hover:text-white transition-colors">dharaanish@gmail.com</span>
                            </motion.a>
                            ...
                            >
                                ...
                                <span className="relative z-10 font-orbitron text-[10px] md:text-sm tracking-widest text-text-secondary group-hover:text-white transition-colors">+91 9629023423</span>
                            </motion.a>
                            ...
                            >
                                ...
                                <span className="relative z-10 font-orbitron text-[10px] md:text-sm tracking-widest text-text-secondary group-hover:text-white transition-colors">GITHUB</span>
                            </motion.a>
                            ...
                            >
                                ...
                                <span className="relative z-10 font-orbitron text-[10px] md:text-sm tracking-widest text-text-secondary group-hover:text-white transition-colors">LINKEDIN</span>
                            </motion.a>
                        </div>
                    </div>
