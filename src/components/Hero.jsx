                    ...
                    <div className="flex-1 text-center lg:text-left max-w-2xl order-2 lg:order-1">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10 w-full max-w-xl mx-auto lg:mx-0">
                            ...
                            >
                                ...
                                <span className="relative z-10 font-orbitron text-[10px] md:text-sm tracking-widest text-text-secondary group-hover:text-white transition-colors">EMAIL</span>
                            </motion.a>
                            ...
                            >
                                ...
                                <span className="relative z-10 font-orbitron text-[10px] md:text-sm tracking-widest text-text-secondary group-hover:text-white transition-colors">CALL</span>
                            </motion.a>
